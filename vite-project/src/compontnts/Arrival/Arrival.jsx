            ...
            <div className="container">
              <div className="row">
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-lg-12 pt-5">
                  ...
                  <p className="desc">Step into the season in style with our latest collection. From timeless essentials to bold statement pieces, our new arrivals are designed to refresh your wardrobe with modern silhouettes, rich textures, and must-have colors. <br/>Whether you're dressing up or keeping it casual, find the perfect look to match your mood and elevate every moment.</p>
